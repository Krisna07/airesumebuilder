        ...
        <div className='grid md:grid-cols-3 gap-8'>
          ...
          <div className='md:col-span-2 space-y-8'>
            ...
            {experiences && experiences.length > 0 && (
              <section>
                <h2 className='text-2xl font-bold text-gray-800 mb-4 border-b-2 border-blue-500 pb-2'>Experiences</h2>
            ...
            {educations && educations.length > 0 && (
              <section>
                <h2 className='text-2xl font-bold text-gray-800 mb-4 border-b-2 border-blue-500 pb-2'>Educations</h2>
          ...
          <div className='space-y-8'>
              ...
              <section>
                ...
                <div className='space-y-4'>
                  {skills.map((skillGroup, index) => (
                    <div key={index}>
                      {skillGroup.type && <h3 className='font-semibold text-gray-700 mb-2'>{skillGroup.type}</h3>}
                      {skillGroup.skills && (
            ...
            {certificates && certificates.length > 0 && (
              <section>
                <h2 className='text-xl font-bold text-gray-800 mb-4 border-b-2 border-blue-500 pb-2'>Certifications</h2>
