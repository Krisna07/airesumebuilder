...
const Navbar = () => {
  ...
  return (
    <nav className='w-full grid place-items-center sticky top-0 my-1 transition-all ease-in-out shadow'>
      <div className='min-[800px]:w-[800px] p-2 px-2  flex items-center justify-between   '>
