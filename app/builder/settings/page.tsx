...
/**
 * Account Settings Page (inside Dashboard)
 * 
 * Moved from /account to /builder/settings
 * Contains all account management functionality:
 * - Profile section (name, email)
 * - Password section (change password, forgot password flow)
